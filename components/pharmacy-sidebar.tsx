      ...
      <nav className="p-3 space-y-2">
        <Link
          ...
          className={`flex items-center gap-3 p-3 rounded-md ${
            isActive("/pharmacy/dashboard") ? "bg-blue-200 text-blue-800" : "hover:bg-gray-100"
          }`}
        >
          <Home size={18} />
        ...
        <Link
          ...
          className={`flex items-center gap-3 p-3 rounded-md ${
            isActive("/pharmacy/orders") ? "bg-blue-200 text-blue-800" : "hover:bg-gray-100"
          }`}
        >
          <Clock size={18} />
        ...
        <Link
          ...
          className={`flex items-center gap-3 p-3 rounded-md ${
            isActive("/pharmacy/profile") ? "bg-blue-200 text-blue-800" : "hover:bg-gray-100"
          }`}
        >
          <User size={18} />
